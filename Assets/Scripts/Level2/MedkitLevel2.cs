...
public class MedkitLevel2 : MonoBehaviour
{
    private PlayerHealth _refHealth;
    private float _idleSpeed = 0.5f;
    private Level2MedkitSpawner _refMedkit;


    void Start()
    {
        _refHealth = GameObject.Find("Character").GetComponent<PlayerHealth>();
        _refMedkit = GameObject.Find("MedkitSpawner").GetComponent<Level2MedkitSpawner>();
    }
